...
function SignupForm() {
  ...
  const { status, error, signupWithEmail, loginWithGoogle, setError } = useFirebaseAuth();
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <User className="pointer-events-none absolute left-2.5 top-1/2 size-3.5 -translate-y-1/2 text-zinc-400" />
                <Input
                  id="name"
                  autoFocus
